...
def generate_summary(text):
    ...
    summary_text =  model.generate_content(f"Summarize the following document:\n\n{text[:3000]}")  # Limiting input size
    return summary_text
...
def retrieve_and_answer(query):
    ...
    return  model.generate_content(f"Based on the following document context, answer the question:\n\n{context}\n\nQuestion: {query}\nAnswer:")
